...
def test_trapezoidal():
    ...
    assert integrate.trapezoidal(f2, 0, 1, 10_000) == pytest.approx(2/math.pi, abs=1e-2)
...
def test_monte_carlo():
    ...
    assert integrate.monte_carlo(f2, 0, 1, 10_000) == pytest.approx(2/math.pi, abs=1e-2)
